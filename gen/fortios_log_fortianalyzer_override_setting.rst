:source: fortios_log_fortianalyzer_override_setting.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_log_fortianalyzer_override_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_fortianalyzer_override_setting</span> - Override FortiAnalyzer settings. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>log_fortianalyzer_override_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">enc_algorithm</span> - Enable/disable sending FortiAnalyzer log data with SSL encryption. <span class="li-normal">type: str</span> <span class="li-normal">choices: high-medium, high, low</span>
 ...
 <td>no</td>
        ...
        <li> <span class="li-head">hmac_algorithm</span> - FortiAnalyzer IPsec tunnel HMAC algorithm. <span class="li-normal">type: str</span> <span class="li-normal">choices: sha256, sha1</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">override</span> - Enable/disable overriding FortiAnalyzer settings or use global settings. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">serial</span> - Serial numbers of the FortiAnalyzer. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">use_management_vdom</span> - Enable/disable use of management VDOM IP address as source IP for logs sent to FortiAnalyzer. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
