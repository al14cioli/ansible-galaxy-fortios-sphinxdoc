:source: fortios_firewall_wildcard_fqdn_group.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_wildcard_fqdn_group</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_wildcard_fqdn_group</span> - Config global Wildcard FQDN address groups. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_wildcard_fqdn_group</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">color</span> - GUI icon color. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">member</span> - Address group members. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Address name. Source firewall.wildcard-fqdn.custom.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">visibility</span> - Enable/disable address visibility. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
