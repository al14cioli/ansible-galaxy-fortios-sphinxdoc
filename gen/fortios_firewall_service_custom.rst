...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_service_custom</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_service_custom</span> - Configure custom services. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">app_category</span> - Application category ID. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">app_service_type</span> - Application service type. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, app-id, app-category</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">application</span> - Application ID. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">category</span> - Service category. Source firewall.service.category.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">check_reset_range</span> - Configure the type of ICMP error message verification. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, strict, default</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">helper</span> - Helper name. <span class="li-normal">type: str</span> <span class="li-normal">choices: auto, disable, ftp, tftp, ras, h323, tns, mms, sip, pptp, rtsp, dns-udp, dns-tcp, pmap, rsh, dcerpc, mgcp, gtp-c, gtp-u, gtp-b</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">session_ttl</span> - Session TTL (300 - 604800, 0 = default). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">udp_idle_timer</span> - UDP half close timeout (0 - 86400 sec, 0 = default). <span class="li-normal">type: int</span>
