...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">domain_controller</span> - Domain for which to decrypt CIFS traffic. Source cifs.domain-controller.server-name. <span class="li-normal">type: str</span>
