:source: fortios_switch_controller_network_monitor_settings.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_network_monitor_settings</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_network_monitor_settings</span> - Configure network monitor settings. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_network_monitor_settings</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">network_monitoring</span> - Enable/disable passive gathering of information by FortiSwitch units concerning other network devices. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
