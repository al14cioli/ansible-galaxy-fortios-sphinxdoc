:source: fortios_firewall_multicast_policy6.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_multicast_policy6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_multicast_policy6</span> - Configure IPv6 multicast NAT policies. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_multicast_policy6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">dstaddr</span> - IPv6 destination address name. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Address name. Source firewall.multicast-address6.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">srcaddr</span> - IPv6 source address name. <span class="li-normal">type: list</span>
      ...
      - name: Configure IPv6 multicast NAT policies.
        fortios_firewall_multicast_policy6:
          ...
          firewall_multicast_policy6:
            ...
            srcaddr:
             -
                name: "default_name_14 (source firewall.address6.name firewall.addrgrp6.name)"
