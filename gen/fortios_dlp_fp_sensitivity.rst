:source: fortios_dlp_fp_sensitivity.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_dlp_fp_sensitivity</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 </tr>
...
.. raw:: html
    ...
    <li> <span class="li-head">dlp_fp_sensitivity</span> - Create self-explanatory DLP sensitivity levels to be used when setting sensitivity under config fp-doc-source. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - DLP Sensitivity Levels. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
