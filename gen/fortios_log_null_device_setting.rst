:source: fortios_log_null_device_setting.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_log_null_device_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_null_device_setting</span> - Settings for null device logging. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">status</span> - Enable/disable statistics collection for when no external logging destination, such as FortiAnalyzer, is present (data is not saved). <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
