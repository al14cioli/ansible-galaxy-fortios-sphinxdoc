:source: fortios_switch_controller_qos_qos_policy.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_qos_qos_policy</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_qos_qos_policy</span> - Configure FortiSwitch QoS policy. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_qos_qos_policy</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">default_cos</span> - Default cos queue for untagged packets. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">queue_policy</span> - QoS egress queue policy. Source switch-controller.qos.queue-policy.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">trust_dot1p_map</span> - QoS trust 802.1p map. Source switch-controller.qos.dot1p-map.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">trust_ip_dscp_map</span> - QoS trust ip dscp map. Source switch-controller.qos.ip-dscp-map.name. <span class="li-normal">type: str</span>
