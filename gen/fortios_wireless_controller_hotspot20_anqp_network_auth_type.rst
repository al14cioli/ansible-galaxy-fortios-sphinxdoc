:source: fortios_wireless_controller_hotspot20_anqp_network_auth_type.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_wireless_controller_hotspot20_anqp_network_auth_type</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_hotspot20_anqp_network_auth_type</span> - Configure network authentication type. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_hotspot20_anqp_network_auth_type</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">auth_type</span> - Network authentication type. <span class="li-normal">type: str</span> <span class="li-normal">choices: acceptance-of-terms, online-enrollment, http-redirection, dns-redirection</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Authentication type name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">url</span> - Redirect URL. <span class="li-normal">type: str</span>
