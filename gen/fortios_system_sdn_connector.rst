...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_sdn_connector</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">access_key</span> - AWS access key ID. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">external_ip</span> - Configure GCP external IP. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">group_name</span> - Group name of computers. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ibm_region</span> - IBM cloud region name. <span class="li-normal">type: str</span> <span class="li-normal">choices: us-south, us-east, germany, great-britain, japan, australia</span>
 ...
 <td>no</td>
        ...
        <li> <span class="li-head">login_endpoint</span> - Azure Stack login enpoint. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">nic</span> - Configure Azure network interface. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">ip</span> - Configure IP configuration. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">region</span> - AWS region name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">route</span> - Configure GCP route. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">route_table</span> - Configure Azure route table. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">route</span> - Configure Azure route. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">secret_key</span> - AWS secret access key. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">server_list</span> - Server address list of the remote SDN connector. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">type</span> - Type of SDN connector. <span class="li-normal">type: str</span> <span class="li-normal">choices: aci, aws, azure, gcp, nsx, nuage, oci, openstack, alicloud, kubernetes, vmware, sepm, aci-direct, ibm</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">update_interval</span> - Dynamic object update interval (0 - 3600 sec, 0 means disabled). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">use_metadata_iam</span> - Enable/disable using IAM role from metadata to call API. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">vcenter_password</span> - vCenter server password for NSX quarantine. <span class="li-normal">type: password_aes256</span> </li>
