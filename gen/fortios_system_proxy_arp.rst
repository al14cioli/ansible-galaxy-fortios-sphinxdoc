:source: fortios_system_proxy_arp.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_proxy_arp</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_proxy_arp</span> - Configure proxy-ARP. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">end_ip</span> - End IP of IP range to be proxied. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">id</span> - Unique integer ID of the entry. <span class="li-normal">type: int</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">interface</span> - Interface acting proxy-ARP. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ip</span> - IP address or start IP to be proxied. <span class="li-normal">type: str</span>
