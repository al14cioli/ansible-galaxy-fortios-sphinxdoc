:source: fortios_firewall_policy46.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_policy46</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_policy46</span> - Configure IPv4 to IPv6 policies. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Address name. Source firewall.vip46.name firewall.vipgrp46.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">fixedport</span> - Enable/disable fixed port for this policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ippool</span> - Enable/disable use of IP Pools for source NAT. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">logtraffic</span> - Enable/disable traffic logging for this policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">permit_any_host</span> - Enable/disable allowing any host. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">srcintf</span> - Source interface name. Source system.zone.name system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">tcp_mss_receiver</span> - TCP Maximum Segment Size value of receiver (0 - 65535) <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">tcp_mss_sender</span> - TCP Maximum Segment Size value of sender (0 - 65535). <span class="li-normal">type: int</span>
