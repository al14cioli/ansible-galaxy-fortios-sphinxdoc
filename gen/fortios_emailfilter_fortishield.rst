:source: fortios_emailfilter_fortishield.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_emailfilter_fortishield</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">emailfilter_fortishield</span> - Configure FortiGuard - AntiSpam. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">spam_submit_force</span> - Enable/disable force insertion of a new mime entity for the submission text. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_submit_srv</span> - Hostname of the spam submission server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">spam_submit_txt2htm</span> - Enable/disable conversion of text email to HTML email. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
