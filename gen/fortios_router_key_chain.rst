:source: fortios_router_key_chain.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_router_key_chain</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">router_key_chain</span> - Configure key-chain. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">key</span> - Configuration method to edit key settings. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">accept_lifetime</span> - Lifetime of received authentication key (format: hh:mm:ss day month year). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">id</span> - Key ID (0 - 2147483647). <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">key_string</span> - Password for the key (max. = 35 characters). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">send_lifetime</span> - Lifetime of sent authentication key (format: hh:mm:ss day month year). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Key-chain name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
