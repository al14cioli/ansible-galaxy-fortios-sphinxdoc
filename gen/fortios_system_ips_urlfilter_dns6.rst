:source: fortios_system_ips_urlfilter_dns6.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_ips_urlfilter_dns6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_ips_urlfilter_dns6</span> - Configure IPS URL filter IPv6 DNS servers. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_ips_urlfilter_dns6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">address6</span> - IPv6 address of DNS server. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable this server for IPv6 DNS queries. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
