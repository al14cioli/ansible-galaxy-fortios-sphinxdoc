:source: fortios_switch_controller_switch_log.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_switch_log</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_switch_log</span> - Configure FortiSwitch logging (logs are transferred to and inserted into FortiGate event log). <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_switch_log</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable adding FortiSwitch logs to FortiGate event log. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
