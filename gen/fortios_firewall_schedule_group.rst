:source: fortios_firewall_schedule_group.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_schedule_group</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_schedule_group</span> - Schedule group configuration. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">member</span> - Schedules added to the schedule group. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Schedule name. Source firewall.schedule.onetime.name firewall.schedule.recurring.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Schedule group name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
