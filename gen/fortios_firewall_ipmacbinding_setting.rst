:source: fortios_firewall_ipmacbinding_setting.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_ipmacbinding_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_ipmacbinding_setting</span> - Configure IP to MAC binding settings. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_ipmacbinding_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">bindthroughfw</span> - Enable/disable use of IP/MAC binding to filter packets that would normally go through the firewall. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">bindtofw</span> - Enable/disable use of IP/MAC binding to filter packets that would normally go to the firewall. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">undefinedhost</span> - Select action to take on packets with IP/MAC addresses not in the binding list . <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, block</span>
