:source: fortios_emailfilter_iptrust.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_emailfilter_iptrust</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">emailfilter_iptrust</span> - Configure AntiSpam IP trust. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">entries</span> - Spam filter trusted IP addresses. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">addr_type</span> - Type of address. <span class="li-normal">type: str</span> <span class="li-normal">choices: ipv4, ipv6</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">id</span> - Trusted IP entry ID. <span class="li-normal">type: int</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">ip4_subnet</span> - IPv4 network address or network address/subnet mask bits. <span class="li-normal">type: str</span>
