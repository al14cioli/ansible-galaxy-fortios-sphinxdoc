...
.. raw:: html
 ...
 <tr>
 <td>fortios_ftp_proxy_explicit</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">outgoing_ip</span> - Outgoing FTP requests will leave from this IP address. An interface must have this IP address. <span class="li-normal">type: str</span>
