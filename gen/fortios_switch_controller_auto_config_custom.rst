:source: fortios_switch_controller_auto_config_custom.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_auto_config_custom</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_auto_config_custom</span> - Policies which can override the 'default' for specific ISL/ICL/FortiLink interface. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_auto_config_custom</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">name</span> - Auto-Config FortiLink or ISL/ICL interface name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">switch_binding</span> - Switch binding list. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">policy</span> - Custom auto-config policy. Source switch-controller.auto-config.policy.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">switch_id</span> - Switch name. <span class="li-normal">type: str</span>
