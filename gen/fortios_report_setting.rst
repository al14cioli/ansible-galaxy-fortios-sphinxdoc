:source: fortios_report_setting.py
...
.. raw:: html
    ...
    <li> <span class="li-head">report_setting</span> - Report setting configuration. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">fortiview</span> - Enable/disable historical FortiView. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">pdf_report</span> - Enable/disable PDF report. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">report_source</span> - Report log source. <span class="li-normal">type: list</span> <span class="li-normal">choices: forward-traffic, sniffer-traffic, local-deny-traffic</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">top_n</span> - Number of items to populate (100 - 4000). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">web_browsing_threshold</span> - Web browsing time calculation threshold (3 - 15 min). <span class="li-normal">type: int</span>
