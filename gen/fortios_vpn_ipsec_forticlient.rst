:source: fortios_vpn_ipsec_forticlient.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_vpn_ipsec_forticlient</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">vpn_ipsec_forticlient</span> - Configure FortiClient policy realm. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">phase2name</span> - Phase 2 tunnel name that you defined in the FortiClient dialup configuration. Source vpn.ipsec.phase2.name vpn.ipsec.phase2-interface .name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">realm</span> - FortiClient realm name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable this FortiClient configuration. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">usergroupname</span> - User group name for FortiClient users. Source user.group.name. <span class="li-normal">type: str</span>
