...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_link_monitor</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">failtime</span> - Number of retry attempts before the server is considered down (1 - 10) <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">interval</span> - Detection interval (1 - 3600 sec). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">protocol</span> - Protocols used to monitor the server. <span class="li-normal">type: list</span> <span class="li-normal">choices: ping, tcp-echo, udp-echo, http, twamp, ping6</span>
 ...
 <td>no</td>
        ...
        <li> <span class="li-head">recoverytime</span> - Number of successful responses received before server is considered recovered (1 - 10). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">server</span> - IP address of the server(s) to be monitored. <span class="li-normal">type: list</span>
