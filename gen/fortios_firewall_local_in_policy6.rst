:source: fortios_firewall_local_in_policy6.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_local_in_policy6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_local_in_policy6</span> - Configure user defined IPv6 local-in policies. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_local_in_policy6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">service</span> - Service object from available options. Separate names with a space. <span class="li-normal">type: list</span>
