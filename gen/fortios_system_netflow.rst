:source: fortios_system_netflow.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_netflow</span> - Configure NetFlow. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">active_flow_timeout</span> - Timeout to report active flows (1 - 60 min). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">collector_ip</span> - Collector IP. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">collector_port</span> - NetFlow collector port number. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">inactive_flow_timeout</span> - Timeout for periodic report of finished flows (10 - 600 sec). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">template_tx_timeout</span> - Timeout for periodic template flowset transmission (1 - 1440 min). <span class="li-normal">type: int</span>
