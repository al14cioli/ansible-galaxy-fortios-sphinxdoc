:source: fortios_firewall_ttl_policy.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_ttl_policy</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_ttl_policy</span> - Configure TTL policies. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">action</span> - Action to be performed on traffic matching this policy . <span class="li-normal">type: str</span> <span class="li-normal">choices: accept, deny</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">service</span> - Service object(s) from available options. Separate multiple names with a space. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">srcaddr</span> - Source address object(s) from available options. Separate multiple names with a space. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable this TTL policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ttl</span> - Value/range to match against the packet"s Time to Live value (format: ttl[ - ttl_high], 1 - 255). <span class="li-normal">type: str</span>
