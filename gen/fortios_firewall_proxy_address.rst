...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_proxy_address</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_proxy_address</span> - Web proxy address configuration. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">case_sensitivity</span> - Enable to make the pattern case sensitive. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">category</span> - FortiGuard category ID. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">id</span> - Fortiguard category id. <span class="li-normal">type: int</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">color</span> - Integer value to determine the color of the icon in the GUI (1 - 32). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">header</span> - HTTP header name as a regular expression. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">header_name</span> - Name of HTTP header. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">host_regex</span> - Host name as a regular expression. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">path</span> - URL path as a regular expression. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">query</span> - Match the query part of the URL as a regular expression. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">referrer</span> - Enable/disable use of referrer field in the HTTP header to match the address. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">type</span> - Proxy address type. <span class="li-normal">type: str</span> <span class="li-normal">choices: host-regex, url, category, method, ua, header, src-advanced, dst-advanced</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ua</span> - Names of browsers to be used as user agent. <span class="li-normal">type: list</span> <span class="li-normal">choices: chrome, ms, firefox, safari, other</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">visibility</span> - Enable/disable visibility of the object in the GUI. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
