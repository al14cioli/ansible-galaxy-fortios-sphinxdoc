:source: fortios_switch_controller_qos_queue_policy.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_qos_queue_policy</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_qos_queue_policy</span> - Configure FortiSwitch QoS egress queue policy. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_qos_queue_policy</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">cos_queue</span> - COS queue configuration. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">drop_policy</span> - COS queue drop policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: taildrop, weighted-random-early-detection</span>
 ...
 <tr>
 <td>[weighted-random-early-detection]</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">max_rate</span> - Maximum rate (0 - 4294967295 kbps, 0 to disable). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">max_rate_percent</span> - Maximum rate (% of link speed). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">min_rate</span> - Minimum rate (0 - 4294967295 kbps, 0 to disable). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">min_rate_percent</span> - Minimum rate (% of link speed). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">name</span> - Cos queue ID. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - QoS policy name <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">rate_by</span> - COS queue rate by kbps or percent. <span class="li-normal">type: str</span> <span class="li-normal">choices: kbps, percent</span>
