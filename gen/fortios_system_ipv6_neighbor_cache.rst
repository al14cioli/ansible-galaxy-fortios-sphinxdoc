:source: fortios_system_ipv6_neighbor_cache.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_ipv6_neighbor_cache</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_ipv6_neighbor_cache</span> - Configure IPv6 neighbor cache table. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_ipv6_neighbor_cache</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ipv6</span> - IPv6 address (format: xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">mac</span> - MAC address (format: xx:xx:xx:xx:xx:xx). <span class="li-normal">type: str</span>
