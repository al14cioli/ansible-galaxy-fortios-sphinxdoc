:source: fortios_firewall_ipmacbinding_table.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_ipmacbinding_table</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_ipmacbinding_table</span> - Configure IP to MAC address pairs in the IP/MAC binding table. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_ipmacbinding_table</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ip</span> - IPv4 address portion of the pair (format: xxx.xxx.xxx.xxx). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">mac</span> - MAC address portion of the pair (format: xx:xx:xx:xx:xx:xx in hexidecimal). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Name of the pair (optional). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">seq_num</span> - Entry number. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable this IP-mac binding pair. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
