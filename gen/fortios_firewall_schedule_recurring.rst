:source: fortios_firewall_schedule_recurring.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_schedule_recurring</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_schedule_recurring</span> - Recurring schedule configuration. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_schedule_recurring</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">day</span> - One or more days of the week on which the schedule is valid. Separate the names of the days with a space. <span class="li-normal">type: list</span> <span class="li-normal">choices: sunday, monday, tuesday, wednesday, thursday, friday, saturday, none</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">end</span> - Time of day to end the schedule, format hh:mm. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Recurring schedule name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">start</span> - Time of day to start the schedule, format hh:mm. <span class="li-normal">type: str</span>
