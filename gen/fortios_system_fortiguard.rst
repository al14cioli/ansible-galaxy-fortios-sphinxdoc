...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_fortiguard</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_fortiguard</span> - Configure FortiGuard services. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">antispam_cache</span> - Enable/disable FortiGuard antispam request caching. Uses a small amount of memory but improves performance. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">antispam_cache_mpercent</span> - Maximum percent of FortiGate memory the antispam cache is allowed to use (1 - 15%). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">antispam_cache_ttl</span> - Time-to-live for antispam cache entries in seconds (300 - 86400). Lower times reduce the cache size. Higher times may improve performance since the cache will have more entries. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">antispam_expiration</span> - Expiration date of the FortiGuard antispam contract. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">antispam_force_off</span> - Enable/disable turning off the FortiGuard antispam service. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">antispam_license</span> - Interval of time between license checks for the FortiGuard antispam contract. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">antispam_timeout</span> - Antispam query time out (1 - 30 sec). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">anycast_sdns_server_ip</span> - IP address of the FortiGuard anycast DNS rating server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">anycast_sdns_server_port</span> - Port to connect to on the FortiGuard anycast DNS rating server. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ddns_server_ip</span> - IP address of the FortiDDNS server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ddns_server_port</span> - Port used to communicate with FortiDDNS servers. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">fortiguard_anycast</span> - Enable/disable use of FortiGuard"s anycast network. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">fortiguard_anycast_source</span> - Configure which of Fortinet"s servers to provide FortiGuard services in FortiGuard"s anycast network. Default is Fortinet. <span class="li-normal">type: str</span> <span class="li-normal">choices: fortinet, aws, debug</span>
 ...
 <tr>
 <td>outbreak_prevention_cache_mpercent</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <tr>
 <td>outbreak_prevention_expiration</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <tr>
 <td>outbreak_prevention_license</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">proxy_server_ip</span> - IP address of the proxy server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">sandbox_region</span> - Cloud sandbox region. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">sdns_server_ip</span> - IP address of the FortiDNS server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">sdns_server_port</span> - Port used to communicate with FortiDNS servers. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">update_server_location</span> - Signature update server location. <span class="li-normal">type: str</span> <span class="li-normal">choices: usa, any</span>
      ...
      - name: Configure FortiGuard services.
        fortios_system_fortiguard:
          ...
          system_fortiguard:
            ...
            load_balance_servers: "18"
            outbreak_prevention_cache: "enable"
            outbreak_prevention_cache_mpercent: "20"
            outbreak_prevention_cache_ttl: "21"
            outbreak_prevention_expiration: "22"
            outbreak_prevention_force_off: "enable"
            outbreak_prevention_license: "24"
            outbreak_prevention_timeout: "25"
            port: "8888"
            protocol: "udp"
            proxy_password: "<your_own_value>"
            proxy_server_ip: "<your_own_value>"
            proxy_server_port: "30"
            ...
            webfilter_cache_ttl: "41"
            webfilter_expiration: "42"
            webfilter_force_off: "enable"
            webfilter_license: "44"
            webfilter_timeout: "45"
