:source: fortios_system_ha_monitor.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_ha_monitor</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_ha_monitor</span> - Configure HA monitor. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">monitor_vlan</span> - Enable/disable monitor VLAN interfaces. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">vlan_hb_interval</span> - Configure heartbeat interval (seconds). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">vlan_hb_lost_threshold</span> - VLAN lost heartbeat threshold (1 - 60). <span class="li-normal">type: int</span>
