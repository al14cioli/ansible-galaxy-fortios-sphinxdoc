:source: fortios_log_memory_setting.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_log_memory_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_memory_setting</span> - Settings for memory buffer. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">diskfull</span> - Action to take when memory is full. <span class="li-normal">type: str</span> <span class="li-normal">choices: overwrite</span>
 ...
 <td>n/a</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable logging to the FortiGate"s memory. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
