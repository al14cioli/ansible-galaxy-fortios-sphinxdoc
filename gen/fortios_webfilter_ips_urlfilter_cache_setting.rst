:source: fortios_webfilter_ips_urlfilter_cache_setting.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_webfilter_ips_urlfilter_cache_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">webfilter_ips_urlfilter_cache_setting</span> - Configure IPS URL filter cache settings. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">dns_retry_interval</span> - Retry interval. Refresh DNS faster than TTL to capture multiple IPs for hosts. 0 means use DNS server"s TTL only. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">extended_ttl</span> - Extend time to live beyond reported by DNS. 0 means use DNS server"s TTL <span class="li-normal">type: int</span>
