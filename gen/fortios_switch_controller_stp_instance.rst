:source: fortios_switch_controller_stp_instance.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_stp_instance</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_stp_instance</span> - Configure FortiSwitch multiple spanning tree protocol (MSTP) instances. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_stp_instance</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">vlan_range</span> - Configure VLAN range for STP instance. <span class="li-normal">type: list</span>
