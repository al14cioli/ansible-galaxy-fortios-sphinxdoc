...
.. raw:: html
 ...
 <tr>
 <td>fortios_web_proxy_profile</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">headers</span> - Configure HTTP forwarded requests headers. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">action</span> - Action when HTTP the header forwarded. <span class="li-normal">type: str</span> <span class="li-normal">choices: add-to-request, add-to-response, remove-from-request, remove-from-response</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">content</span> - HTTP header"s content. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">dstaddr6</span> - Destination address and address group names (IPv6). <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">id</span> - HTTP forwarded header id. <span class="li-normal">type: int</span> <span class="li-required">required: True</span>
