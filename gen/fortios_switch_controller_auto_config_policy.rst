:source: fortios_switch_controller_auto_config_policy.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_auto_config_policy</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_auto_config_policy</span> - Policy definitions which can define the behavior on auto configured interfaces. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_auto_config_policy</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">igmp_flood_report</span> - Enable/disable IGMP flood report. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">igmp_flood_traffic</span> - Enable/disable IGMP flood traffic. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Auto-Config policy name <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">qos_policy</span> - Auto-Config QoS policy. Source switch-controller.qos.qos-policy.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">storm_control_policy</span> - Auto-Config storm control policy. Source switch-controller.storm-control-policy.name. <span class="li-normal">type: str</span>
