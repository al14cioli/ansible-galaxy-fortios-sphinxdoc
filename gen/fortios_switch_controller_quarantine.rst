:source: fortios_switch_controller_quarantine.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_quarantine</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_quarantine</span> - Configure FortiSwitch quarantine support. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_quarantine</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">targets</span> - Quarantine MACs. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">tag</span> - Tags for the quarantine MAC. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">tags</span> - Tag string(eg. string1 string2 string3). <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
