...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_interface_policy6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_interface_policy6</span> - Configure IPv6 interface policies. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_interface_policy6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">dstaddr6</span> - IPv6 address object to limit traffic monitoring to network traffic sent to the specified address or range. <span class="li-normal">type: list</span>
 ...
 <td>n/a</td>
        ...
        <li> <span class="li-head">service6</span> - Service name. <span class="li-normal">type: list</span>
 ...
 <td>n/a</td>
        ...
        <li> <span class="li-head">srcaddr6</span> - IPv6 address object to limit traffic monitoring to network traffic sent from the specified address or range. <span class="li-normal">type: list</span>
