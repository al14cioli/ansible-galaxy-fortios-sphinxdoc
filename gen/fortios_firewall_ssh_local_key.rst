:source: fortios_firewall_ssh_local_key.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_ssh_local_key</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_ssh_local_key</span> - SSH proxy local keys. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - SSH proxy local key name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">password</span> - Password for SSH private key. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">private_key</span> - SSH proxy private key, encrypted with a password. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">public_key</span> - SSH proxy public key. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">source</span> - SSH proxy local key source type. <span class="li-normal">type: str</span> <span class="li-normal">choices: built-in, user</span>
