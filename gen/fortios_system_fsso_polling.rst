:source: fortios_system_fsso_polling.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_fsso_polling</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_fsso_polling</span> - Configure Fortinet Single Sign On (FSSO) server. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">auth_password</span> - Password to connect to FSSO Agent. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">authentication</span> - Enable/disable FSSO Agent Authentication. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">listening_port</span> - Listening port to accept clients (1 - 65535). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable FSSO Polling Mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
