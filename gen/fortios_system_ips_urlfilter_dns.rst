:source: fortios_system_ips_urlfilter_dns.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_ips_urlfilter_dns</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_ips_urlfilter_dns</span> - Configure IPS URL filter DNS servers. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_ips_urlfilter_dns</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">address</span> - DNS server IP address. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ipv6_capability</span> - Enable/disable this server for IPv6 queries. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable using this DNS server for IPS URL filter DNS queries. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
