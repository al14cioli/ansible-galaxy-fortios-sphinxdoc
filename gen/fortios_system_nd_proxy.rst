:source: fortios_system_nd_proxy.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_nd_proxy</span> - Configure IPv6 neighbor discovery proxy (RFC4389). <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">member</span> - Interfaces using the neighbor discovery proxy. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable neighbor discovery proxy. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
