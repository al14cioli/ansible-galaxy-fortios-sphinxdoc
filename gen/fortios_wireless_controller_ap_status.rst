:source: fortios_wireless_controller_ap_status.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_wireless_controller_ap_status</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_ap_status</span> - Configure access point status (rogue | accepted | suppressed). <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_ap_status</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">bssid</span> - Access Point"s (AP"s) BSSID. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">id</span> - AP ID. <span class="li-normal">type: int</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ssid</span> - Access Point"s (AP"s) SSID. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Access Point"s (AP"s) status: rogue, accepted, or supressed. <span class="li-normal">type: str</span> <span class="li-normal">choices: rogue, accepted, suppressed</span>
