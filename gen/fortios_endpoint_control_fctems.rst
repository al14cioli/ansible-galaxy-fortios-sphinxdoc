:source: fortios_endpoint_control_fctems.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_endpoint_control_fctems</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">endpoint_control_fctems</span> - Configure FortiClient Enterprise Management Server (EMS) entries. <span class="li-normal">type: dict</span>
 ...
 <td>no</td>
        ...
        <li> <span class="li-head">call_timeout</span> - FortiClient EMS call timeout in milliseconds (500 - 30000 milliseconds). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">certificate</span> - FortiClient EMS certificate. Source certificate.remote.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status_check_interval</span> - FortiClient EMS call timeout in seconds (1 - 120 seconds). <span class="li-normal">type: int</span>
