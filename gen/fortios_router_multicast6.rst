...
.. raw:: html
 ...
 <tr>
 <td>fortios_router_multicast6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">interface</span> - Protocol Independent Multicast (PIM) interfaces. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">hello_holdtime</span> - Time before old neighbour information expires (1 - 65535 sec). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">hello_interval</span> - Interval between sending PIM hello messages  (1 - 65535 sec).. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">rp_address</span> - Statically configured RP addresses. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">id</span> - ID of the entry. <span class="li-normal">type: int</span> <span class="li-required">required: True</span>
