:source: fortios_wireless_controller_hotspot20_anqp_ip_address_type.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_wireless_controller_hotspot20_anqp_ip_address_type</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_hotspot20_anqp_ip_address_type</span> - Configure IP address type availability. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_hotspot20_anqp_ip_address_type</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">ipv4_address_type</span> - IPv4 address type. <span class="li-normal">type: str</span> <span class="li-normal">choices: not-available, public, port-restricted, single-NATed-private, double-NATed-private, port-restricted-and-single-NATed, port-restricted-and-double-NATed, not-known</span>
 ...
 <tr>
 <td>[port-restricted-and-single-NATed]</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <tr>
 <td>[port-restricted-and-double-NATed]</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ipv6_address_type</span> - IPv6 address type. <span class="li-normal">type: str</span> <span class="li-normal">choices: not-available, available, not-known</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - IP type name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
