:source: fortios_system_sms_server.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_sms_server</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_sms_server</span> - Configure SMS server for sending SMS messages to support user authentication. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">mail_server</span> - Email-to-SMS server domain name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Name of SMS server. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
