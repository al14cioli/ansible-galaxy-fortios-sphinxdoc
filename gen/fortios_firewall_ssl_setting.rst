...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_ssl_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_ssl_setting</span> - SSL proxy settings. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">abbreviate_handshake</span> - Enable/disable use of SSL abbreviated handshake. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cert_cache_capacity</span> - Maximum capacity of the host certificate cache (0 - 500). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cert_cache_timeout</span> - Time limit to keep certificate cache (1 - 120 min). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">kxp_queue_threshold</span> - Maximum length of the CP KXP queue. When the queue becomes full, the proxy switches cipher functions to the main CPU (0 - 512). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">no_matching_cipher_action</span> - Bypass or drop the connection when no matching cipher is found. <span class="li-normal">type: str</span> <span class="li-normal">choices: bypass, drop</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">proxy_connect_timeout</span> - Time limit to make an internal connection to the appropriate proxy process (1 - 60 sec). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">session_cache_capacity</span> - Capacity of the SSL session cache (--Obsolete--) (1 - 1000). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">session_cache_timeout</span> - Time limit to keep SSL session state (1 - 60 min). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ssl_queue_threshold</span> - Maximum length of the CP SSL queue. When the queue becomes full, the proxy switches cipher functions to the main CPU (0 - 512). <span class="li-normal">type: int</span>
