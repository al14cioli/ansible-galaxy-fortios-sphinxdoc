:source: fortios_system_virtual_wire_pair.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_virtual_wire_pair</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_virtual_wire_pair</span> - Configure virtual wire pairs. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_virtual_wire_pair</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">member</span> - Interfaces belong to the virtual-wire-pair. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Virtual-wire-pair name. Must be a unique interface name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">wildcard_vlan</span> - Enable/disable wildcard VLAN. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
