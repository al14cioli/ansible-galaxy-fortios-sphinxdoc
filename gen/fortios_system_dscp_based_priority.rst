:source: fortios_system_dscp_based_priority.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_dscp_based_priority</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_dscp_based_priority</span> - Configure DSCP based priority table. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_dscp_based_priority</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">ds</span> - DSCP(DiffServ) DS value (0 - 63). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">priority</span> - DSCP based priority level. <span class="li-normal">type: str</span> <span class="li-normal">choices: low, medium, high</span>
