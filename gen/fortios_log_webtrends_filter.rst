:source: fortios_log_webtrends_filter.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_log_webtrends_filter</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_webtrends_filter</span> - Filters for WebTrends. <span class="li-normal">type: dict</span>
 ...
 <td>n/a</td>
        ...
        <li> <span class="li-head">filter</span> - Webtrends log filter. <span class="li-normal">type: str</span>
 ...
 <td>no</td>
        ...
        <li> <span class="li-head">severity</span> - Lowest severity level to log to WebTrends. <span class="li-normal">type: str</span> <span class="li-normal">choices: emergency, alert, critical, error, warning, notification, information, debug</span>
