:source: fortios_system_autoupdate_push_update.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_autoupdate_push_update</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_autoupdate_push_update</span> - Configure push updates. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_autoupdate_push_update</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">address</span> - Push update override server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">override</span> - Enable/disable push update override server. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">port</span> - Push update override port. (Do not overlap with other service ports) <span class="li-normal">type: int</span>
