:source: fortios_dlp_sensitivity.py
...
.. raw:: html
    ...
    <li> <span class="li-head">dlp_sensitivity</span> - Create self-explanatory DLP sensitivity levels to be used when setting sensitivity under config fp-doc-source. <span class="li-normal">type: dict</span>
