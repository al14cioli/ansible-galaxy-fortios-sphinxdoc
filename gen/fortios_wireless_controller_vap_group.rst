...
.. raw:: html
 ...
 <tr>
 <td>fortios_wireless_controller_vap_group</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_vap_group</span> - Configure virtual Access Point (VAP) groups. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_vap_group</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">vaps</span> - List of SSIDs to be included in the VAP group. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - vap name Source wireless-controller.vap.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
