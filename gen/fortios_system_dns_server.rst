:source: fortios_system_dns_server.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_dns_server</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_dns_server</span> - Configure DNS servers. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">dnsfilter_profile</span> - DNS filter profile. Source dnsfilter.profile.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">mode</span> - DNS server mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: recursive, non-recursive, forward-only</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - DNS server name. Source system.interface.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
