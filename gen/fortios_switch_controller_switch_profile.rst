:source: fortios_switch_controller_switch_profile.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_switch_profile</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_switch_profile</span> - Configure FortiSwitch switch profile. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">login_passwd</span> - Login password of managed FortiSwitch. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">login_passwd_override</span> - Enable/disable overriding the admin administrator password for a managed FortiSwitch with the FortiGate admin administrator account password. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - FortiSwitch Profile name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
