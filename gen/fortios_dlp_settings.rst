:source: fortios_dlp_settings.py
...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">chunk_size</span> - Maximum fingerprint chunk size.  **Changing will flush the entire database**. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">db_mode</span> - Behaviour when the maximum size is reached. <span class="li-normal">type: str</span> <span class="li-normal">choices: stop-adding, remove-modified-then-oldest, remove-oldest</span>
 ...
 <tr>
 <td>[remove-modified-then-oldest]</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
