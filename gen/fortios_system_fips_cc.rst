:source: fortios_system_fips_cc.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_fips_cc</span> - Configure FIPS-CC mode. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">entropy_token</span> - Enable/disable/dynamic entropy token. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable, dynamic</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">key_generation_self_test</span> - Enable/disable self tests after key generation. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>key_generation_self_test</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">self_test_period</span> - Self test period. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable FIPS-CC mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
