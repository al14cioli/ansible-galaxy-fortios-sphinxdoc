:source: fortios_webfilter_ips_urlfilter_setting.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_webfilter_ips_urlfilter_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">webfilter_ips_urlfilter_setting</span> - Configure IPS URL filter settings. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>webfilter_ips_urlfilter_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">gateway</span> - Gateway IP address for this route. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">geo_filter</span> - Filter based on geographical location. Route will NOT be installed if the resolved IP address belongs to the country in the filter. <span class="li-normal">type: str</span>
