:source: fortios_log_webtrends_setting.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_log_webtrends_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_webtrends_setting</span> - Settings for WebTrends. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">server</span> - Address of the remote WebTrends server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable logging to WebTrends. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
