:source: fortios_firewall_auth_portal.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_auth_portal</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_auth_portal</span> - Configure firewall authentication portals. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">groups</span> - Firewall user groups permitted to authenticate through this portal. Separate group names with spaces. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">identity_based_route</span> - Name of the identity-based route that applies to this portal. Source firewall.identity-based-route.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">portal_addr</span> - Address (or FQDN) of the authentication portal. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">portal_addr6</span> - IPv6 address (or FQDN) of authentication portal. <span class="li-normal">type: str</span>
