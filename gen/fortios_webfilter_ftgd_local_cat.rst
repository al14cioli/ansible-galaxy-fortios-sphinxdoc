:source: fortios_webfilter_ftgd_local_cat.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_webfilter_ftgd_local_cat</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">webfilter_ftgd_local_cat</span> - Configure FortiGuard Web Filter local categories. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>webfilter_ftgd_local_cat</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">desc</span> - Local category description. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">id</span> - Local category ID. <span class="li-normal">type: int</span>
