...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ldap_server</span> - LDAP server name. Source user.ldap.name. <span class="li-normal">type: str</span>
 ...
 <td>no</td>
        ...
        <li> <span class="li-head">principal</span> - Kerberos service principal, e.g. HTTP/fgt.example.com@EXAMPLE.COM. <span class="li-normal">type: str</span>
