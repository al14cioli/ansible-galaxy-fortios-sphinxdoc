:source: fortios_emailfilter_options.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_emailfilter_options</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">emailfilter_options</span> - Configure AntiSpam options. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">dns_timeout</span> - DNS query time out (1 - 30 sec). <span class="li-normal">type: int</span>
