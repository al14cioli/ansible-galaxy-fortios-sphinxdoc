:source: fortios_router_aspath_list.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_router_aspath_list</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">router_aspath_list</span> - Configure Autonomous System (AS) path lists. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">name</span> - AS path list name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">rule</span> - AS path list rule. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">action</span> - Permit or deny route-based operations, based on the route"s AS_PATH attribute. <span class="li-normal">type: str</span> <span class="li-normal">choices: deny, permit</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">regexp</span> - Regular-expression to match the Border Gateway Protocol (BGP) AS paths. <span class="li-normal">type: str</span>
