:source: fortios_user_device_group.py
...
.. raw:: html
    ...
    <li> <span class="li-head">user_device_group</span> - Configure device groups. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">member</span> - Device group member. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Device name. Source user.device.alias user.device-category.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Device group name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
