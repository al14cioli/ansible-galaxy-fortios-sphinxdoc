:source: fortios_antivirus_heuristic.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_antivirus_heuristic</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">antivirus_heuristic</span> - Configure global heuristic options. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">mode</span> - Enable/disable heuristics and determine how the system behaves if heuristics detects a problem. <span class="li-normal">type: str</span> <span class="li-normal">choices: pass, block, disable</span>
