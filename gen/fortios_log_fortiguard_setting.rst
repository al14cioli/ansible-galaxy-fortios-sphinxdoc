...
.. raw:: html
 ...
 <tr>
 <td>fortios_log_fortiguard_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">conn_timeout</span> - FortiCloud connection timeout in seconds <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">enc_algorithm</span> - Enable and set the SSL security level for for sending encrypted logs to FortiCloud. <span class="li-normal">type: str</span> <span class="li-normal">choices: high-medium, high, low</span>
