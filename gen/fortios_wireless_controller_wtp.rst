...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ip_fragment_preventing</span> - Method by which IP fragmentation is prevented for CAPWAP tunneled control and data packets . <span class="li-normal">type: list</span> <span class="li-normal">choices: tcp-mss-adjust, icmp-unreachable</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">auto_power_high</span> - Automatic transmission power high limit in decibels (dB) of the measured power referenced to one milliwatt (mW), or dBm (10 - 17 dBm). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">band</span> - WiFi band that Radio 1 operates on. <span class="li-normal">type: str</span> <span class="li-normal">choices: 802.11a, 802.11b, 802.11g, 802.11n, 802.11n-5G, 802.11n,g-only, 802.11g-only, 802.11n-only, 802.11n-5G-only, 802.11ac, 802.11ac,n-only, 802.11ac-only, 802.11ax-5G, 802.11ax,ac-only, 802.11ax,ac,n-only, 802.11ax-5G-only, 802.11ax, 802.11ax,n-only, 802.11ax,n,g-only, 802.11ax-only, 802.11ac-2G</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">band</span> - WiFi band that Radio 3 operates on. <span class="li-normal">type: str</span> <span class="li-normal">choices: 802.11a, 802.11b, 802.11g, 802.11n, 802.11n-5G, 802.11n,g-only, 802.11g-only, 802.11n-only, 802.11n-5G-only, 802.11ac, 802.11ac,n-only, 802.11ac-only, 802.11ax-5G, 802.11ax,ac-only, 802.11ax,ac,n-only, 802.11ax-5G-only, 802.11ax, 802.11ax,n-only, 802.11ax,n,g-only, 802.11ax-only, 802.11ac-2G</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">band</span> - WiFi band that Radio 4 operates on. <span class="li-normal">type: str</span> <span class="li-normal">choices: 802.11a, 802.11b, 802.11g, 802.11n, 802.11n-5G, 802.11n,g-only, 802.11g-only, 802.11n-only, 802.11n-5G-only, 802.11ac, 802.11ac,n-only, 802.11ac-only, 802.11ax-5G, 802.11ax,ac-only, 802.11ax,ac,n-only, 802.11ax-5G-only, 802.11ax, 802.11ax,n-only, 802.11ax,n,g-only, 802.11ax-only, 802.11ac-2G</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">tun_mtu_downlink</span> - Downlink tunnel MTU in octets. Set the value to either 0 (by default), 576, or 1500. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">tun_mtu_uplink</span> - Uplink tunnel maximum transmission unit (MTU) in octets (eight-bit bytes). Set the value to either 0 (by default), 576, or 1500. <span class="li-normal">type: int</span>
        ...
        fortios_wireless_controller_wtp:
          ...
          wireless_controller_wtp:
            ...
            radio_1:
                ...
                vaps:
                 -
                    name: "default_name_69 (source wireless-controller.vap-group.name wireless-controller.vap.name)"
            radio_2:
                auto_power_high: "71"
                auto_power_level: "enable"
                auto_power_low: "73"
                ...
                vaps:
                 -
                    name: "default_name_89 (source wireless-controller.vap-group.name wireless-controller.vap.name)"
            radio_3:
                auto_power_high: "91"
                auto_power_level: "enable"
                auto_power_low: "93"
                ...
                vaps:
                 -
                    name: "default_name_109 (source wireless-controller.vap-group.name system.interface.name)"
            radio_4:
                auto_power_high: "111"
                auto_power_level: "enable"
                auto_power_low: "113"
                ...
                vaps:
                 -
                    name: "default_name_128 (source wireless-controller.vap-group.name system.interface.name)"
