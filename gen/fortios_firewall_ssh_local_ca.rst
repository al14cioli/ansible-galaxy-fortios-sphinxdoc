:source: fortios_firewall_ssh_local_ca.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_ssh_local_ca</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_ssh_local_ca</span> - SSH proxy local CA. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - SSH proxy local CA name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">source</span> - SSH proxy local CA source type. <span class="li-normal">type: str</span> <span class="li-normal">choices: built-in, user</span>
