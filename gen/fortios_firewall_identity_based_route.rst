:source: fortios_firewall_identity_based_route.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_identity_based_route</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_identity_based_route</span> - Configure identity based routing. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_identity_based_route</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">device</span> - Outgoing interface for the rule. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">gateway</span> - IPv4 address of the gateway (Format: xxx.xxx.xxx.xxx ). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">groups</span> - Select one or more group(s) from available groups that are allowed to use this route. Separate group names with a space. <span class="li-normal">type: list</span>
