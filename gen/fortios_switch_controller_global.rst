...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_global</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">custom_command</span> - List of custom commands to be pushed to all FortiSwitches in the VDOM. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">disable_discovery</span> - Prevent this FortiSwitch from discovering. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">mac_retention_period</span> - Time in hours after which an inactive MAC is removed from client DB. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">sn_dns_resolution</span> - Enable/disable DNS resolution of the FortiSwitch unit"s IP address by use of its serial number. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
