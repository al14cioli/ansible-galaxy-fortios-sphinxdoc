:source: fortios_vpn_ipsec_concentrator.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_vpn_ipsec_concentrator</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">vpn_ipsec_concentrator</span> - Concentrator configuration. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">member</span> - Names of up to 3 VPN tunnels to add to the concentrator. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Member name. Source vpn.ipsec.manualkey.name vpn.ipsec.phase1.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Concentrator name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">src_check</span> - Enable to check source address of phase 2 selector. Disable to check only the destination selector. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
