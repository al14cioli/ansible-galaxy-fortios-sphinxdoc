:source: fortios_system_vdom_radius_server.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_vdom_radius_server</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_vdom_radius_server</span> - Configure a RADIUS server to use as a RADIUS Single Sign On (RSSO) server for this VDOM. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_vdom_radius_server</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">name</span> - Name of the VDOM that you are adding the RADIUS server to. Source system.vdom.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">radius_server_vdom</span> - Use this option to select another VDOM containing a VDOM RSSO RADIUS server to use for the current VDOM. Source system.vdom.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable the RSSO RADIUS server for this VDOM. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
