:source: fortios_system_alias.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_alias</span> - Configure alias command. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">command</span> - Command list to execute. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Alias command name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
