:source: fortios_switch_controller_auto_config_default.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_auto_config_default</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_auto_config_default</span> - Policies which are applied automatically to all ISL/ICL/FortiLink interfaces. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_auto_config_default</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">fgt_policy</span> - Default FortiLink auto-config policy. Source switch-controller.auto-config.policy.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">icl_policy</span> - Default ICL auto-config policy. Source switch-controller.auto-config.policy.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">isl_policy</span> - Default ISL auto-config policy. Source switch-controller.auto-config.policy.name. <span class="li-normal">type: str</span>
