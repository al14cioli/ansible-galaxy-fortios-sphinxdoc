...
.. raw:: html
    ...
    <li> <span class="li-head">system_vdom_dns</span> - Configure DNS servers for a non-management VDOM. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ip6_primary</span> - Primary IPv6 DNS server IP address for the VDOM. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ip6_secondary</span> - Secondary IPv6 DNS server IP address for the VDOM. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">primary</span> - Primary DNS server IP address for the VDOM. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">secondary</span> - Secondary DNS server IP address for the VDOM. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">server_hostname</span> - DNS server host name list. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">source_ip</span> - Source IP for communications with the DNS server. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">vdom_dns</span> - Enable/disable configuring DNS servers for the current VDOM. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
