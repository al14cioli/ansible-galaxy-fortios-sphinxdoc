:source: fortios_switch_controller_switch_group.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_switch_group</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_switch_group</span> - Configure FortiSwitch switch groups. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_switch_group</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">description</span> - Optional switch group description. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">fortilink</span> - FortiLink interface to which switch group members belong. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">members</span> - FortiSwitch members belonging to this switch group. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Managed device ID. Source switch-controller.managed-switch.switch-id. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>no</td>
            ...
            <li> <span class="li-head">switch_id</span> - Managed device ID. Source switch-controller.managed-switch.switch-id. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Switch group name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
