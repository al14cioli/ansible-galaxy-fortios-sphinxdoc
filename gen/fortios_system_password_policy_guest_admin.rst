:source: fortios_system_password_policy_guest_admin.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_password_policy_guest_admin</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_password_policy_guest_admin</span> - Configure the password policy for guest administrators. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_password_policy_guest_admin</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">apply_to</span> - Guest administrator to which this password policy applies. <span class="li-normal">type: list</span> <span class="li-normal">choices: guest-admin-password</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">change_4_characters</span> - Enable/disable changing at least 4 characters for a new password (This attribute overrides reuse-password if both are enabled). <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">expire_day</span> - Number of days after which passwords expire (1 - 999 days). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">expire_status</span> - Enable/disable password expiration. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">reuse_password</span> - Enable/disable reusing of password (if both reuse-password and change-4-characters are enabled, change-4-characters overrides). <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
