:source: fortios_web_proxy_url_match.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_web_proxy_url_match</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">web_proxy_url_match</span> - Exempt URLs from web proxy forwarding and caching. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">cache_exemption</span> - Enable/disable exempting this URL pattern from caching. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">forward_server</span> - Forward server name. Source web-proxy.forward-server.name web-proxy.forward-server-group.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Configure a name for the URL to be exempted. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable exempting the URLs matching the URL pattern from web proxy forwarding and caching. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">url_pattern</span> - URL pattern to be exempted from web proxy forwarding and caching. <span class="li-normal">type: str</span>
