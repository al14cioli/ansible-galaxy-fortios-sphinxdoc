:source: fortios_wanopt_remote_storage.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_wanopt_remote_storage</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">wanopt_remote_storage</span> - Configure a remote cache device as Web cache storage. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">local_cache_id</span> - ID that this device uses to connect to the remote device. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">remote_cache_id</span> - ID of the remote device to which the device connects. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">remote_cache_ip</span> - IP address of the remote device to which the device connects. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable using remote device as Web cache storage. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
