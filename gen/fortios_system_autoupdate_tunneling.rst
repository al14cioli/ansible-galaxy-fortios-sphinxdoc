:source: fortios_system_autoupdate_tunneling.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_autoupdate_tunneling</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_autoupdate_tunneling</span> - Configure web proxy tunnelling for the FDN. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable web proxy tunnelling. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
