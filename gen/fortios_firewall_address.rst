...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_address</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_address</span> - Configure IPv4 addresses. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">allow_routing</span> - Enable/disable use of this address in the static route configuration. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">associated_interface</span> - Network interface associated with address. Source system.interface.name system.zone.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">cache_ttl</span> - Defines the minimal TTL of individual IP addresses in FQDN cache measured in seconds. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">clearpass_spt</span> - SPT (System Posture Token) value. <span class="li-normal">type: str</span> <span class="li-normal">choices: unknown, healthy, quarantine, checkup, transient, infected</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">country</span> - IP addresses associated to a specific country. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">end_ip</span> - Final IP address (inclusive) in the range for the address. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">fqdn</span> - Fully Qualified Domain Name address. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">fsso_group</span> - FSSO group(s). <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - FSSO group name. Source user.adgrp.name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">interface</span> - Name of interface whose IP address is to be used. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">list</span> - IP address list. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">obj_tag</span> - Tag of dynamic address object. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">obj_type</span> - Object type. <span class="li-normal">type: str</span> <span class="li-normal">choices: ip, mac</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">policy_group</span> - Policy group name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">sdn</span> - SDN. Source system.sdn-connector.name. <span class="li-normal">type: str</span> <span class="li-normal">choices: aci, aws, azure, gcp, nsx, nuage, oci, openstack</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">start_ip</span> - First IP address (inclusive) in the range for the address. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">sub_type</span> - Sub-type of address. <span class="li-normal">type: str</span> <span class="li-normal">choices: sdn, clearpass-spt, fsso, ems-tag</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">subnet</span> - IP address and subnet mask of address. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">subnet_name</span> - Subnet name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">type</span> - Type of address. <span class="li-normal">type: str</span> <span class="li-normal">choices: ipmask, iprange, fqdn, geography, wildcard, wildcard-fqdn, dynamic, interface-subnet, mac</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">visibility</span> - Enable/disable address visibility in the GUI. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
          ...
          firewall_address:
            ...
            tagging:
             -
                ...
                tags:
                 -
                    name: "default_name_41 (source system.object-tagging.tags.name)"
