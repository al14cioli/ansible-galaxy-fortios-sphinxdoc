:source: fortios_system_auto_script.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_auto_script</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_auto_script</span> - Configure auto script. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">interval</span> - Repeat interval in seconds. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Auto script name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">output_size</span> - Number of megabytes to limit script output to (10 - 1024). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">repeat</span> - Number of times to repeat this script (0 = infinite). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">script</span> - List of FortiOS CLI commands to repeat. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">start</span> - Script starting mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: manual, auto</span>
