...
.. raw:: html
 ...
 <tr>
 <td>fortios_log_memory_global_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">log_memory_global_setting</span> - Global settings for memory logging. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>log_memory_global_setting</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">max_size</span> - Maximum amount of memory that can be used for memory logging in bytes. <span class="li-normal">type: int</span>
