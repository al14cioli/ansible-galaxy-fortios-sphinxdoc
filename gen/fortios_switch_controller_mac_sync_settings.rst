:source: fortios_switch_controller_mac_sync_settings.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_mac_sync_settings</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 </tr>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_mac_sync_settings</span> - Configure global MAC synchronization settings. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_mac_sync_settings</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 </tr>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">mac_sync_interval</span> - Time interval between MAC synchronizations (30 - 1800 sec). <span class="li-normal">type: int</span>
