...
.. raw:: html
 ...
 <tr>
 <td>fortios_firewall_ssl_server</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_ssl_server</span> - Configure SSL servers. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">add_header_x_forwarded_proto</span> - Enable/disable adding an X-Forwarded-Proto header to forwarded requests. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>add_header_x_forwarded_proto</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">mapped_port</span> - Mapped server service port (1 - 65535). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">port</span> - Server service port (1 - 65535). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ssl_cert</span> - Name of certificate for SSL connections to this server . Source vpn.certificate.local.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ssl_client_renegotiation</span> - Allow or block client renegotiation by server. <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, deny, secure</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ssl_max_version</span> - Highest SSL/TLS version to negotiate. <span class="li-normal">type: str</span> <span class="li-normal">choices: tls-1.0, tls-1.1, tls-1.2</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ssl_min_version</span> - Lowest SSL/TLS version to negotiate. <span class="li-normal">type: str</span> <span class="li-normal">choices: tls-1.0, tls-1.1, tls-1.2</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ssl_mode</span> - SSL/TLS mode for encryption and decryption of traffic. <span class="li-normal">type: str</span> <span class="li-normal">choices: half, full</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">ssl_send_empty_frags</span> - Enable/disable sending empty fragments to avoid attack on CBC IV. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
