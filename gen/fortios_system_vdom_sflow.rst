:source: fortios_system_vdom_sflow.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_vdom_sflow</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_vdom_sflow</span> - Configure sFlow per VDOM to add or change the IP address and UDP port that FortiGate sFlow agents in this VDOM use to send sFlow datagrams to an sFlow collector. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">vdom_sflow</span> - Enable/disable the sFlow configuration for the current VDOM. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
