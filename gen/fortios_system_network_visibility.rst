:source: fortios_system_network_visibility.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_network_visibility</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_network_visibility</span> - Configure network visibility settings. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_network_visibility</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">destination_hostname_visibility</span> - Enable/disable logging of destination hostname visibility. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <tr>
 <td>destination_hostname_visibility</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">destination_location</span> - Enable/disable logging of destination geographical location visibility. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">destination_visibility</span> - Enable/disable logging of destination visibility. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">source_location</span> - Enable/disable logging of source geographical location visibility. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
