:source: fortios_switch_controller_virtual_port_pool.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_virtual_port_pool</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_virtual_port_pool</span> - Configure virtual pool. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_virtual_port_pool</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">description</span> - Virtual switch pool description. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - Virtual switch pool name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
