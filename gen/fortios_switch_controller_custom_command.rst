:source: fortios_switch_controller_custom_command.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_custom_command</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_custom_command</span> - Configure the FortiGate switch controller to send custom commands to managed FortiSwitch devices. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_custom_command</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">command</span> - String of commands to send to FortiSwitch devices (For example (%0a = return key): config switch trunk %0a edit myTrunk %0a set members port1 port2 %0a end %0a). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">command_name</span> - Command name called by the FortiGate switch controller in the execute command. <span class="li-normal">type: str</span>
