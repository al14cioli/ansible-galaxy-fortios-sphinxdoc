:source: fortios_webfilter_ips_urlfilter_setting6.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_webfilter_ips_urlfilter_setting6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">webfilter_ips_urlfilter_setting6</span> - Configure IPS URL filter settings for IPv6. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>webfilter_ips_urlfilter_setting6</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">device</span> - Interface for this route. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">distance</span> - Administrative distance (1 - 255) for this route. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">gateway6</span> - Gateway IPv6 address for this route. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">geo_filter</span> - Filter based on geographical location. Route will NOT be installed if the resolved IPv6 address belongs to the country in the filter. <span class="li-normal">type: str</span>
