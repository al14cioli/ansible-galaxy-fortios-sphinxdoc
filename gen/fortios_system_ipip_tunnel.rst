:source: fortios_system_ipip_tunnel.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_ipip_tunnel</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_ipip_tunnel</span> - Configure IP in IP Tunneling. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">auto_asic_offload</span> - Enable/disable tunnel ASIC offloading. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">interface</span> - Interface name that is associated with the incoming traffic from available options. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">local_gw</span> - IPv4 address for the local gateway. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - IPIP Tunnel name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">remote_gw</span> - IPv4 address for the remote gateway. <span class="li-normal">type: str</span>
