...
.. raw:: html
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">allow_monitor</span> - Enable/disable allowing the central management server to remotely monitor this FortiGate <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">server_list</span> - Additional severs that the FortiGate can use for updates (for AV, IPS, updates) and ratings (for web filter and antispam ratings) servers. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">server_type</span> - FortiGuard service type. <span class="li-normal">type: str</span> <span class="li-normal">choices: update, rating</span>
