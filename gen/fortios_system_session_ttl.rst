:source: fortios_system_session_ttl.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_session_ttl</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_session_ttl</span> - Configure global session TTL timers for this FortiGate. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">default</span> - Default timeout. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">port</span> - Session TTL port. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">end_port</span> - End port number. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">id</span> - Table entry ID. <span class="li-normal">type: int</span> <span class="li-required">required: True</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">protocol</span> - Protocol (0 - 255). <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">start_port</span> - Start port number. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">timeout</span> - Session timeout (TTL). <span class="li-normal">type: str</span>
